...
<body class="font-sans bg-gray-900 text-white">
        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('movis.index') }}" class="hover:text-gray-300">Movies</a>
                </li>
            ...
            <div class="flex flex-col md:flex-row items-center">
                <livewire:serche-movies>
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="{{ route('dashboard') }}">
                        <img src="/images/dashboard.png" alt="avatar" class="rounded-full w-8 h-8">
    ...
    <footer class="border border-t border-gray-800">
        <div class="container mx-auto text-sm px-4 py-6">
            Powered by <a href="https://github.com/AmineDevF" class="underline hover:text-gray-300">Amine Hmidouhe</a>
        </div>
    </footer>
    <livewire:scripts>
    @yield('scripts')
